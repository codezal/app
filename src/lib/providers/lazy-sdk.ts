// Lazy ai-sdk paket yükleyici. Provider adapter'ları paket adıyla çağırır;
// gerçek import edip cache'liyoruz. Vite tüm dynamic import'ları ayrı chunk yapar
// — sadece kullanılan provider'ın SDK'sı çalışma zamanında bundle'a girer.
...
// (Codezal SDK çağrılarını minimum yüzeyde tutar — sadece `create*({...})(modelId)`.)
