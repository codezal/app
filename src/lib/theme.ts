...
export function applyAppearance(appearance: Appearance, userPresets: ThemePreset[] = []): void {
  ...
  root.style.setProperty("--codezal-ui-font", quoteFamily(appearance.uiFont || "Roboto"))
  ...
  root.setAttribute("data-translucent-sidebar", appearance.translucentSidebar ? "on" : "off")
}
