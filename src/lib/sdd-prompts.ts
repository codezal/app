...
const STAGE_INSTRUCTION: Record<SddStage, string> = {
  ...
  design:
    "Current stage: DESIGN. Produce a visual design specification for this product. Derive a detailed UI description from the requirement document (layout, key sections, components, color & typography direction) and record it as an annotated textual mockup (ASCII or structured description). After writing it, briefly record the chosen design direction in the requirement document.",
  prototype:
