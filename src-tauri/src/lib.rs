...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            code_map::codemap_references,
            code_map::codemap_dead,
            code_map::codemap_importers,
            code_map::codemap_hierarchy,
            code_map::codemap_diff_impact,
            code_map::codemap_xlang,
